...
In this demo we will show you how to reconstruct a non-cartesian dataset (spiral) using the BART toolbox.

## Setup for demo

After the previous demo, you might be used to the following part : 

First you need to create the gadgetron config file **demo_2_nonCart.xml**, because we use a matlab gadget, this file will be pretty simple :
...
* the gadgetron config file : **demo_2_nonCart.xml**
* the matlab function called in from gadgetron : 
...
* open 2 terminals. In the first one, launch gadgetron server : `gadgetron`
